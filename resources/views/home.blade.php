                                    ...
                                    <div class="right-item">
                                        ...
                                        <div class="flex-area">
                                            ...
                                            <div class="right-area">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <button type="button" class="borrow-button btn btn-primary" data-dismiss="modal" data-toggle="modal" data-target="#borrowModal{{ $book->id }}" onclick="showModalBorrow({{ $book->id }})">
                                                                    Pinjam
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal modal-borrow-book confirmation-modal fade"
                                                    id="borrowModal{{ $book->id }}" tabindex="-1" aria-labelledby="borrowModal"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="modal-flex">
                                                                    ...
                                                                    <p class="reminder-text">
                                                                        Durasi waktu peminjaman maksimal 14 hari, jika
                                                                        lebih secara otomatis buku pinjaman akan kembali
                                                                        ke katalog.
                                                                    </p>
